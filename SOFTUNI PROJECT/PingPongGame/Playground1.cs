...
namespace PingPongGame
{
    ...
    public partial class Playground1 : Form
    {
        ...
        #endregion
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData) //Help Menu + Pause + Exit
        {
        ...
        private void restartButton_lbl_Click(object sender, EventArgs e) //Restart button
        {
            ...
            CursorcoordinаteY = Cursor.Position.Y;
            Point pt = new Point(PadcoordinаteX, CursorcoordinаteY);
            ball.Top = RandomGenerator(250, 300);
        ...
        public static int RandomGenerator(int i, int p) //random generator
        {
        ...
        #endregion // DONT OPEN /DONT OPEN //Dont Open
